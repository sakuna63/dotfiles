...
pos = dl.uiElements[0].uiElements[19].uiElements[0].uiElements[3].uiElements[0].uiElements[1].position();
app.doShellScript('/usr/local/bin/cliclick m:' + pos[0] + ',' + pos[1]);

// copy password
btn = dl.uiElements[0].uiElements[19].uiElements[0].uiElements[3].uiElements[0].uiElements['コピー'];
btn.click();
"
